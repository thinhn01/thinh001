...
const dice_images = [
  "https://i.imgur.com/O0jJHOS.jpg",
  "https://i.imgur.com/PUr087d.jpg",
  "https://i.imgur.com/MxTVjO9.jpg",
  "https://i.imgur.com/lFtVbQc.jpg",
  "https://i.imgur.com/yLWcprX.jpg",
  "https://i.imgur.com/Zs6UI5c.jpg"
];
...
module.exports.run = async function({ api, event, args, getText, Users, Threads, Currencies }) {
  ...
  switch (args[0]) {
    ...
    case "start": {
      ...
      let shakingGif = (await axios.get('https://i.imgur.com/z6K6WIt.gif', { responseType: "stream" }).catch(e => console.log(e))).data;
