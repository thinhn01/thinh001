...
try{
    ...
    const res = await axios.get(`https://api-ttk.herokuapp.com/social/pinterest?text=${encodeURIComponent(keySearchs)}&apikey=shiron`);
    ...
    console.log(err)
    return api.sendMessage("Vượt quá số lượng ảnh cho phép",event.threadID);
}
}