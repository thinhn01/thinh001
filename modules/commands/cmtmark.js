module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "D-Jukie",
    description: "Comment của mark trên fb",
...
module.exports.run = async function ({
    ...
    let path = __dirname + `/cache/mark${senderID}.png`;
    var text = args.join(" ");
    ...
    if( text.length < 42) {
    let bg = (
        await axios.get(`https://i.imgur.com/8iYSfI9.png`, {
    ...
    const lines = await this.wrapText(ctx, text, 360);
    ...
    let bg = (
        await axios.get(`https://i.imgur.com/jLFZIuB.png`, {
            responseType: "arraybuffer",
        })
    ).data;
