...
module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "oắt", 
    description: "Xem thông tin về 12 thì trong tiếng anh mà không phải lên google",
    commandCategory: "oắt",
    usages: "",
    cooldowns: 5, 
};
...
const { threadID, messageID, senderID } = event;
 ...
 module.exports.run = async ({ api, event, handleReply }) => {
    const fs = require("fs");
    const { threadID, messageID, senderID } = event;
    return api.sendMessage({ body: "==== 12 thì trong tiếng anh ====" +
                ...
                "\n\nReply tin nhắn theo số để xem từng thì nha ❤"
            ,attachment: fs.createReadStream(__dirname + `/cache/12thi.jpg`)}, event.threadID, (error, info) => {
