module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "Shiron",
    description: "Tải video (download được tất cả video)",
...
if (!args[0]){ return api.sendMessage("Bạn phải ngập url video !!!", event.threadID, event.messageID);}
const link = args.join(" ");
try {
const res = await axios.get(`https://hoangdogianguyenofficial.herokuapp.com/videodowload?url=${encodeURIComponent(link)}`);
