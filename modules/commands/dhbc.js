...
module.exports.handleReply = async function ({
    ...
    case "choosee": {
        ...
        case "2": {
            ...
            const res = await axios.get(`https://raw.githubusercontent.com/Shiron-Official/apikey-DATA/main/datadhbc.json`);
        ...
        case "1": {
            api.unsendMessage(handleReply.messageID);
            const res = await axios.get(`https://raw.githubusercontent.com/Shiron-Official/apikey-DATA/main/datadhbc2.json`);
