...
module.exports.onLoad = () => {
  ...
  if (!fs.existsSync(dirMaterial + "demngayyeu.png")) request("https://i.imgur.com/mjufA0k.jpg").pipe(fs.createWriteStream(dirMaterial + "demngayyeu.png"));
}
...
module.exports.handleEvent = async ({ event, api, Users }) => {
  ...
  let dateBegin = new Date(2021, 12, 10, 00, 00, 00).getTime()
  ...
  var msg = {
    ...
    attachment: fs.createReadStream(__dirname + `/noprefix/demngayyeu.png`)
  }
  // Gọi bot
