  ...
  try {
    ...
    if(!args[0] || isNaN(args[0]) == true || args[0] == "help") {
      if(!fs.existsSync(__dirname+"/cache/hexcolor.png")) {
       let getimg = (await axios.get(`https://i.imgur.com/IjfjPpC.jpg`, { responseType: "arraybuffer" })).data;
    ...
    const background = await Canvas.loadImage("https://i.imgur.com/LuC1LZi.jpg");
    ...
    var loadkhung = await Canvas.loadImage("https://i.imgur.com/Ee0ncPR.png");//("https://s1.uphinh.org/2021/06/24/1624551553171.png");
