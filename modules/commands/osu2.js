...
async function drawcanvas(js,playmode,event,api){
    ...
    try{
        var avatarimg = await loadImage(js.avatar_url)
            ...
            var avatarimg = await loadImage(`https://i.imgur.com/FBDyZMM.png`)
            }
...
module.exports.onLoad = async()=>{
    ...
    if (!existsSync(path.resolve(__dirname,"cache","backgroundcard.png"))){ global.utils.downloadFile("https://i.imgur.com/kHgr8eB.png", path.resolve(__dirname,"cache","backgroundcard.png"))}
    if (!existsSync(path.resolve(__dirname,"cache","avatarcornerround.png"))){ global.utils.downloadFile("https://i.imgur.com/46Zkv7z.png", path.resolve(__dirname,"cache","avatarcornerround.png"))}
    if (!existsSync(path.resolve(__dirname,"cache","osu.png"))){ global.utils.downloadFile("https://i.imgur.com/gMH84Oy.png", path.resolve(__dirname,"cache","osu.png"))}
    if (!existsSync(path.resolve(__dirname,"cache","mania.png"))){ global.utils.downloadFile("https://i.imgur.com/isnC624.png", path.resolve(__dirname,"cache","mania.png"))}
    if (!existsSync(path.resolve(__dirname,"cache","catch.png"))){global.utils.downloadFile("https://i.imgur.com/IUnuMzD.png", path.resolve(__dirname,"cache","catch.png"))}
    if (!existsSync(path.resolve(__dirname,"cache","taiko.png"))){global.utils.downloadFile("https://i.imgur.com/CQ6R59d.png", path.resolve(__dirname,"cache","taiko.png"))}
    if (!existsSync(path.resolve(__dirname,"cache","Varela.ttf"))){global.utils.downloadFile("https://raw.githubusercontent.com/Shiron-Official/download/main/Varela.ttf", path.resolve(__dirname,"cache","Varela.ttf"))}
}
