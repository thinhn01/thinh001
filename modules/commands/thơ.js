...
const fs = require("fs");
const res = await axios.get(`https://raw.githubusercontent.com/Shiron-Official/API_Date/main/CaDao.js`);
const anh = await axios.get(`https://hoangdogianguyenofficial.herokuapp.com/images/naughty`);
