...
module.exports.run = async function ({ api, args, event, Currencies, Users }) {
  const axios = require("axios");
    ...
    //const datagame = (await axios.get("https://api.mincute.repl.co/game/vuatiengviet")).data;
    ...
    let Avatar = (await axios.get(`https://hoangdogianguyenofficial.herokuapp.com/vuatiengviet/image?word=${encodeURI(answer)}`, { responseType: "arraybuffer" } )).data; 
