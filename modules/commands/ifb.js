...
module.exports.run = async function({ api, event }) {
  ...
  const take = await axios.get(`https://hoangdogianguyenofficial.herokuapp.com/info?uid=${uid}`);
  var fl = take.data.data.follow_user ? `${take.data.data.follow_user}` : "Không công khai";
  var name = take.data.data.fullname
  var pf = take.data.data.url_profile
  var hom = take.data.data.hometown ? `${take.data.data.hometown}` : "Không công khai";
  var gender = take.data.data.gender == 'male' ? "Nam" : take.data.data.gender == 'female' ? "Nữ" : "Không công khai";
    var birthday = take.data.data.birthday ? `${take.data.data.birthday}` : "Không công khai";
    var love = take.data.data.relationship_status ? `${take.data.data.relationship_status}` : "Không công khai";
    var location = take.data.data.location ? `${take.data.data.location}` : "Không công khai";
