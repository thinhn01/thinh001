...
let gif = (await axios.get("https://i.imgur.com/OctWGJs.gif", {
        responseType: "stream"
      })).data;
...
if(1 > body || body > 5) return api.sendMessage("Bạn chỉ có thể chọn từ 1 đến 5", threadID, messageID);
  if(body == "1"){
    var tienan = cuoc,
    win = "https://i.imgur.com/CAqatDC.jpg",
      losse = "https://i.imgur.com/4ovziKq.jpg"
  }
  else if(body == "2"){
    var tienan = cuoc * 2,
    win = "https://i.imgur.com/4BOy8In.jpg",
      losse = "https://i.imgur.com/SqOLfXu.jpg"
  }
  else if(body == "3"){
    var tienan = cuoc * 12,
    win = "https://i.imgur.com/tzsAVEF.jpg",
      losse = "https://i.imgur.com/2ABy7mj.jpg"
  }
  else if(body == "4"){
    var tienan = cuoc * 144,
    win = "https://i.imgur.com/Bpxr0Tx.jpg",
      losse = "https://i.imgur.com/0CRZDgg.jpg"
  }
  else if(body == "5"){
    var tienan = cuoc * 2880,
    win = "https://i.imgur.com/FJCdsbV.jpg",
      losse = "https://i.imgur.com/In0tQRp.jpg"
  }
  if( moneyUser < tienan){
