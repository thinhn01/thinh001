...
module.exports.config = {
    name: "xidachnb", // Tên lệnh, được sử dụng trong việc gọi lệnh
...
module.exports.onLoad = async () => {
    ...
    await require('axios').get("https://raw.githubusercontent.com/Shiron-Official/mirai-modules/main/version.json").then(res => {
        if (res.data["xidachnb_x034"] != this.config.version) console.log("-XIDACHNB ĐÃ CÓ PHIÊN BẢN MỚI, LIÊN HỆ ShironUwU ĐỂ ĐƯỢC CẬP NHẬT-");
    })
