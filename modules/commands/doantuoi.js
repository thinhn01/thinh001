...
axios.request(options).then(function (response) {
  ...
  return api.sendMessage(`⚡️Mình đoán bạn khoảng ${age} tuổi`, event.threadID, event.messageID);
}).catch(function (error) {
  return api.sendMessage(`⚡️Không thể xử lí yêu cầu của bạn!!!`, event.threadID, event.messageID);
});
}