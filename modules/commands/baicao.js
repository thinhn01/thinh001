  ...
  var money = data.money     
    ...
    case 'check': {
      for (const key in values.player) {
        ...
        default: {
            console.log("[ Shiron ] » Hi, have a good day.")
        }
    }
}
...
module.exports.onLoad = async () => {
  ...
  console.log("[ INFO ] » Shiron's module");
  console.log("[ DONATE ] » Bạn có thể donate cho tôi để giúp tôi có thêm động lực code");
  console.log("============ Sacombank: 050124512112 - HOANG DO GIA NGUYEN ============")
};
...
function getLinkCard(Value, Suit) {
  return `https://raw.githubusercontent.com/Shiron-Official/data/main/cards/${Value == "J" ? "jack" : Value == "Q" ? "queen" : Value == "K" ? "king" : Value == "A" ? "ace" : Value}_of_${Suit}.png`;
}
