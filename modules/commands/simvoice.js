 ...
 */
 module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "ProCoderMew",
    description: "Chat c\xF9ng con simvoice m\u1EA5t d\u1EA1y nh\u1EA5t",
    commandCategory: "Chat cùng simvoice",
    usages: "[args]",
    cooldowns: 5,
    dependencies: {
        axios: ""
...
async function simsimi(a, b, c) {
    const d = global.nodemodule.axios, { APIKEY: e } = global.configModule.simvoice, g = (a) => encodeURIComponent(a);
    try {
...
module.exports.run = async ({ api: b, event: a, args: c,event }) => {
    ...
    switch (c[0]) {
        case "on":
            return global.procodermew.simsimi.has(d) ? f("B\u1EA1n ch\u01B0a t\u1EAFt simvoice.") : (global.procodermew.simsimi.set(d, e), f("\u0110\xE3 b\u1EADt simvoice th\xE0nh c\xF4ng."));
        case "off":
            return global.procodermew.simsimi.has(d) ? (global.procodermew.simsimi.delete(d), f("\u0110\xE3 t\u1EAFt simvoice th\xE0nh c\xF4ng.")) : f("B\u1EA1n ch\u01B0a b\u1EADt simvoice.");
        default:
