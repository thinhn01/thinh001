module.exports.config = {
    ...
    hasPermssion: 0,
    credits: "D-Jukie",
    description: "Comment của zuck trên fb",
...
module.exports.run = async function ({
    ...
    let path = __dirname + "/cache/zuck.png";
    var text = args.join(" ");
    if (event.type == "message_reply") {
        text = event.messageReply.body
    }
    if (!text)
        return api.sendMessage("Nhập nội dung hoặc reply nội dung mà zuck cmt", threadID, messageID);
    let bg = (
        await axios.get(`https://i.imgur.com/zzQPEb7.jpg`, {
