...
module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
    ...
    switch (handleReply.type) {
        ...
        case "text2": { 
        	api.unsendMessage(handleReply.messageID);
        	return api.sendMessage(`🔍Bạn đã chọn năm sinh là ${event.body}\n(Reply tin nhắn này nhập mô tả của bạn)`,threadID , function (err, info) { 
        		return global.client.handleReply.push({ 
        			type: 'create',
        			name: 'rtc2',
        			author: senderID,
        ...
        case "create": {
            ...
            setTimeout(() => {
            	...
            	var callback = () => api.sendMessage({body:`Đây là ảnh bìa của ${nameSender} 🐧\nUid: ${event.senderID}\nHọ Và Tên: ${text1}\nNăm sinh: ${text2}\nMô tả: ${text3}`,mentions: arraytag,attachment: fs.createReadStream(__dirname + "/cache/fbcover.png")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/fbcover.png"),event.messageID);
